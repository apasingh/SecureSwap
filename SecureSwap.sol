...
contract SecureSwap {
    ...
    // constructor(){
    //   Product memory hardcodedProduct;
    //   hardcodedProduct.id = 1;
    //   hardcodedProduct.seller = payable(address(0xb05c2605f9D58B2c20E35e136Ef129a59c90F76c)); // Seller address
    //   hardcodedProduct.description = "Sample product";
    //   hardcodedProduct.price = 1e14; // Price in wei (0.0001 Sepolia ETH)
    //   hardcodedProduct.sellerDeposit = 1e15; // Seller deposit in wei (0.001 Sepolia ETH)
    //   hardcodedProduct.isSold = false;

    //   products[hardcodedProduct.id] = hardcodedProduct;
    //   productCount++;
